...
$query = "SELECT * FROM survivor WHERE unique_id = ".$_GET["id"].$cid." AND is_dead=0 LIMIT 1"; 
$res = mysql_query($query) or die(mysql_error());
$number = mysql_num_rows($res);

$queryname = "SELECT * FROM profile WHERE unique_id = ".$_GET["id"]." LIMIT 1";		
...
?>	
	<div id="page-heading">
		<h1><? echo "<title>".$rowname['name']." - ".$sitename."</title>"; ?></h1>
		<h1><? echo $rowname['name']; ?> - <? echo $row['unique_id']; ?> - Last save: <? echo $row['last_update']; ?></h1>
	</div>
	<!-- end page-heading -->
